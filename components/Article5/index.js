                    ...
                    <div className="col col-lg-8">
                        <div className="wpo-event-item">
                            <div className="wpo-event-img">
                                <img src='images/event/article5.jpg' alt="mala-suriah-fundi-cmo" />
                            ...
                            <div className="wpo-event-details-text">
                                <h2>Keep learning. Keep growing! Fundi gives 420 Mpebe Primary learners new school bags</h2>
                                <p>
                                ...
                                <p>
                                Because this remains the reality for so many school children, Fundi decided to act decisively – wanting to have a direct and immediate impact.                                
                                </p>
                                <p>
                                Mpebe Primary School in the village of Ga-Modimonthuse in Longdem, Limpopo was selected as a beneficiary of this staff-inspired initiative.                                 </p>
                                <p>
